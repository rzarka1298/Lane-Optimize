...
| [`laneiq/agents/OVERVIEW.md`](laneiq/agents/OVERVIEW.md) | ✅ Policy protocol + agents folder summary | `e4f5fa6` |
| [`laneiq/agents/baselines/OVERVIEW.md`](laneiq/agents/baselines/OVERVIEW.md) | ✅ Three rule-based baselines summary | `e4f5fa6` |
| [`laneiq/agents/baselines/random_agent.md`](laneiq/agents/baselines/random_agent.md) | ✅ Uniform random over valid actions | `e4f5fa6` |
| [`laneiq/agents/baselines/greedy_agent.md`](laneiq/agents/baselines/greedy_agent.md) | ✅ Highest-projected-speed policy | `e4f5fa6` |
| [`laneiq/agents/baselines/safe_rule_agent.md`](laneiq/agents/baselines/safe_rule_agent.md) | ✅ Clear-and-faster policy | `e4f5fa6` |
| `laneiq/eval/` | ⏳ Week 3 |  — |
